...
#' @section ftype: Ca-Ye-Nu
#' @examples
#' hgch_bar_DaNu(sampleData("Da-Nu",nrow = 10))
hgch_bar_DaNu <- hgch_bar_YeNu
...
#' hgch_bar_stack_CaCaNu
#' @name hgch_bar_stack_CaCaNu
#' @param x A data.frame
#' @export
#' @return highcharts viz
#' @section ftype: Ca-Ye-Nu
#' @examples
#' hgch_bar_stack_CaCaNu(sampleData("Ye-Nu-Nu",nrow = 10))
hgch_bar_stack_CaCaNu <- function(data, title = NULL, xAxisTitle = NULL, yAxisTitle = NULL,
...
#' hgch_bar_stack_CaDaNu
#' @name hgch_bar_stack_CaDaNu
#' @param x A data.frame
#' @export
#' @return highcharts viz
#' @section ftype: Ca-Ca-Nu
#' @examples
#' hgch_bar_stack_CaDaNu(sampleData("Ca-Ca-Nu",nrow = 10))
hgch_bar_stack_CaDaNu <- hgch_bar_stack_CaCaNu
