...
hgchmagic offers a several number of functions for interactive visualization. Check [this article](https://datasketch.github.io/hgchmagic/articles/hgchmagic.html) or run `vignette("hgchmagic)` to see how hgchmagic works.
