...
metaStatus <- data.frame("name" = c("hgch_area_DatNum", "hgch_area_CatNum", "hgch_area_YeaNum", "hgch_area_CatCatNum", "hgch_area_CatYeaNum",
                                    ...
                                    "hgch_bar_stacked_100_ver_CatDatNum", "hgch_bar_grouped_ver_CatNumP","hgch_bar_grouped_hor_CatNumP",
                                    "hgch_bar_ver_NumP", "hgch_waterfall_CatNum", "hgch_bar_grouped_ver_CatCat", "hgch_bar_grouped_hor_CatCat",
                                    ...
                                    "hgch_line_CatDatNum", "hgch_2yline_YeaNumNum", "hgch_multilines_YeaNumP", "hgch_slope_CatYeaNum "),
                ...
                El eje 'y' debería centrarse en 0 (cuando hay valores negativos). Argumento que controle los separadores decimales y de miles en las variables numéricas.",
                                       ...
                                       "Ordenar los años", "Ordenar los años", "Ordenar los años", "Ordenar los años", "Ordenar los años", NA, NA, NA, NA)
)
